...
import com.seekcircle.seekbar.R;

public class ProgressCircle extends View {
    protected float mSectionHeight;
    protected float mRadius;
    protected int mMinProgress = 0;
    protected int mMaxProgress = 24;
    protected int mProgress = 0;
    protected float mCenterX;
    protected float mCenterY;
    float currentTemp = 13.5f;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float rotation = 250.0f / (float) relativeMax;
        for (int i = 0; i < relativeMax; ++i) {
            ...
            if (i < relativeProgress) {
                float bias = (float) i / (float) (relativeMax - 10);
            ...
            canvas.drawRoundRect(mSectionRect, 2f, 2f, mPaint);
            canvas.restore();
            updateDimensions(getWidth(), getHeight());
        }
